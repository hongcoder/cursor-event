...
var Cursor = /*#__PURE__*/function () {
  function Cursor(el) {
    ...
    this.onMouseMoveEv = function () {
      ...
      _this.onScaleMouse(); // The window.requestAnimationFrame() method tells the browser that you wish to
  ...
  _createClass(Cursor, [{
    ...
    value: function render() {
      ...
      this.Cursor.style.transform = "translateX(".concat(this.cursorConfigs.x.previous, "px) translateY(").concat(this.cursorConfigs.y.previous, "px)"); //RAF(Request Animation Frame)
